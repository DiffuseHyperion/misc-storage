if (location.host != "chrome.google.com" || !location.pathname.startsWith("/webstor")) {
    location.href = "https://chrome.google.com/webstor" + performance.now().toString(16).slice(1);
}
